...
extension Proto3ArenaLiteUnittest_ForeignEnum: @unchecked Sendable {}
extension Proto3ArenaLiteUnittest_TestAllTypes: @unchecked Sendable {}
extension Proto3ArenaLiteUnittest_TestAllTypes.OneOf_OneofField: @unchecked Sendable {}
extension Proto3ArenaLiteUnittest_TestAllTypes.NestedEnum: @unchecked Sendable {}
...
extension Proto3ArenaLiteUnittest_TestAllTypes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _optionalNestedEnum: Proto3ArenaLiteUnittest_TestAllTypes.NestedEnum = .zero
    var _optionalForeignEnum: Proto3ArenaLiteUnittest_ForeignEnum = .foreignZero
    ...
    var _repeatedNestedMessage: [Proto3ArenaLiteUnittest_TestAllTypes.NestedMessage] = []
    var _repeatedForeignMessage: [Proto3ArenaLiteUnittest_ForeignMessage] = []
    var _repeatedImportMessage: [ProtobufUnittestImport_ImportMessage] = []
    var _repeatedNestedEnum: [Proto3ArenaLiteUnittest_TestAllTypes.NestedEnum] = []
    var _repeatedForeignEnum: [Proto3ArenaLiteUnittest_ForeignEnum] = []
  ...
  static func ==(lhs: Proto3ArenaLiteUnittest_TestAllTypes, rhs: Proto3ArenaLiteUnittest_TestAllTypes) -> Bool {
...
extension Proto3ArenaLiteUnittest_TestAllTypes.NestedMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Proto3ArenaLiteUnittest_TestAllTypes.NestedMessage, rhs: Proto3ArenaLiteUnittest_TestAllTypes.NestedMessage) -> Bool {
...
extension Proto3ArenaLiteUnittest_TestPackedTypes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Proto3ArenaLiteUnittest_TestPackedTypes, rhs: Proto3ArenaLiteUnittest_TestPackedTypes) -> Bool {
...
extension Proto3ArenaLiteUnittest_TestUnpackedTypes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Proto3ArenaLiteUnittest_TestUnpackedTypes, rhs: Proto3ArenaLiteUnittest_TestUnpackedTypes) -> Bool {
...
extension Proto3ArenaLiteUnittest_NestedTestAllTypes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Proto3ArenaLiteUnittest_NestedTestAllTypes, rhs: Proto3ArenaLiteUnittest_NestedTestAllTypes) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Proto3ArenaLiteUnittest_ForeignMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Proto3ArenaLiteUnittest_ForeignMessage, rhs: Proto3ArenaLiteUnittest_ForeignMessage) -> Bool {
...
extension Proto3ArenaLiteUnittest_TestEmptyMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Proto3ArenaLiteUnittest_TestEmptyMessage, rhs: Proto3ArenaLiteUnittest_TestEmptyMessage) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
